...
SECRET_KEY = 'django-insecure-69fy44jj*93d0e=u53u*mh*41j=2u9g5$-yl6yyra)7&ptot9-'
...
LOGGING = {
    ...
    "handlers": {
        "console": {  # always print logs to console
    ...
    "loggers": {
        ...
        "movies": {  # custom app logger (example)
            "handlers": ["console", "file"],
            "level": "DEBUG",
            "propagate": False,
        },
